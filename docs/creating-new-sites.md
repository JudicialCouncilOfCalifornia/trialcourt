...
- Add language support as needed
  ...
  - Add Spanish at minimum in most cases.
- Confirm or adjust robots.txt that will be generated by the RobotsTxt module.
  - `/admin/config/search/robotstxt`
  - If using default setup, compare/use the core file setup under `/web/core/assets/scaffold/files/robots.txt`. Otherwise, configure differently as needed now or later.
