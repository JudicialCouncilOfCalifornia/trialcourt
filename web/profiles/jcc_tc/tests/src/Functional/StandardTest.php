...
class JCCTCTest extends BrowserTestBase {
  ...
  public function testJCCTC() {
    ...
    $this->assertSession()->responseContains(
      'Then she picked out two somebodies,<br />Sally and me'
    );
    $this->submitForm([
    ...
    $this->assertFalse(
      $this->container
        ...
        ->needsUpdates(),
      'After installation, entity schema is up to date.'
    );
    ...
    $this->assertEquals(
      'UNCACHEABLE',
      $this->getSession()->getResponseHeader(
        DynamicPageCacheSubscriber::HEADER
      ),
      'Site-wide contact page cannot be cached by Dynamic Page Cache.'
    );
    ...
    $this->assertEquals(
      ...
      'User profile page is cached by Dynamic Page Cache.'
    );
  }
