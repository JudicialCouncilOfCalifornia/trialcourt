 ...
 */
function jcc_tc_post_update_uninstall_big_pipe() {
  // jcc_tc_update_10004() reinstalled big_pipe so the queued
  ...
  // 'jcc_tc_', so that one is done by now and the module can go
