 ...
 *
 * @FieldWidget(
 *   id = "jcc_elevated_custom_daterange_all_day",
 *   label = @Translation("Date and time range with All day (JCC)"),
 *   field_types = {
 *     "daterange",
 *     "daterange_all_day"
 *   }
 * )
 */
class JccElevatedCustomRfpSolicitationsDateRangeAllDayWidget extends DateRangeDefaultWidget {
  ...
  public function formElement(FieldItemListInterface $items, $delta, array $element, array &$form, FormStateInterface $form_state) {
    ...
    $element['#attached'] = [
      'library' => [
        'jcc_elevated_custom/date_all_day',
      ],
    ];
  ...
  public function massageFormValues(array $values, array $form, FormStateInterface $form_state) {
    ...
    foreach ($values as &$item) {
      ...
      if (!empty($item['value']) && $item['value'] instanceof DrupalDateTime) {
        ...
        $is_all_day = JccElevatedRfpSolicitationsAllDayHelper::isAllDay($item);
