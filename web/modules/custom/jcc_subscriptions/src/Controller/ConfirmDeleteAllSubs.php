...
class ConfirmDeleteAllSubs extends ControllerBase {
  ...
  public function delete(string $member_id = '') {
    ...
    $build = [
      '#markup' => '<div class="jcc-text-section-aside__container jcc-text-section-aside-secondary__container"><div class="body"><br><br><p>' . $user->email . ' ' . $this->t('has been removed from all communications.') . '</p><br><br></div></div>',
    ];
