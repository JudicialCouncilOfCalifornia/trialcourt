...
namespace Drupal\jcc_migrate_source_ui\Plugin\views\field;
 ...
 *
 * @ViewsField("jcc_migrate_source_ui_message")
 */
class JccMigrateSourceLogMessage extends FieldPluginBase {
