...
namespace Drupal\jcc_elevated_sections\Plugin\Linkit\Matcher;
 ...
 *   target_entity = "media",
 *   provider = "jcc_elevated_sections"
 * )
 */
class JccElevatedSectionsMediaMatcher extends EntityMatcher {
  ...
  public function execute($string): SuggestionCollection {
    ...
    foreach ($entities as $entity) {
      ...
      if ($entity->hasField('jcc_section')) {
        $term_id = $entity->get('jcc_section')->getValue();
        if (isset($term_id[0])) {
