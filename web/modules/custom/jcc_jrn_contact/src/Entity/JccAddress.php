...
class JccAddress extends ContentEntityBase implements JccStaffInterface {
  ...
  public static function baseFieldDefinitions(EntityTypeInterface $entity_type) {
    ...
    $fields['mailing_addr1'] = BaseFieldDefinition::create('string')
      ->setLabel(t('Mailing Address Line 1'))
      ->setDescription(t('Mailing address line 1 of the jcc address.'))
      ->setSettings([
        'default_value' => '',
        'max_length' => 255,
        'text_processing' => 0,
    ...
    $fields['mailing_addr2'] = BaseFieldDefinition::create('string')
      ->setLabel(t('Mailing Address Line 2'))
      ->setDescription(t('Mailing address line 2 of the jcc address.'))
      ->setSettings([
        'default_value' => '',
        'max_length' => 255,
        'text_processing' => 0,
    ...
    $fields['mailing_city'] = BaseFieldDefinition::create('string')
      ->setLabel(t('Mailing City'))
      ->setDescription(t('Mailing city of the jcc address.'))
      ->setSettings([
        'default_value' => '',
        'max_length' => 255,
        'text_processing' => 0,
    ...
    $fields['mailing_state'] = BaseFieldDefinition::create('string')
      ->setLabel(t('Mailing State'))
      ->setDescription(t('Mailing state of the jcc address.'))
      ->setSettings([
        'default_value' => '',
        'max_length' => 255,
        'text_processing' => 0,
    ...
    $fields['mailing_zip'] = BaseFieldDefinition::create('string')
      ->setLabel(t('Mailing Zip Code'))
      ->setDescription(t('Mailing zip code of the jcc address.'))
      ->setSettings([
        'default_value' => '',
        'max_length' => 255,
        'text_processing' => 0,
