 ...
 * another environment.
 */
$settings['file_private_path'] = 'sites/default/files/trinity/default/private';
...
if ($is_installer_url) {
  $config_directories = array(
    CONFIG_SYNC_DIRECTORY => 'sites/default/files/trinity',
  );
}
else {
  $config_directories = array(
    CONFIG_SYNC_DIRECTORY => '../config/config-trinity',
  );
}
