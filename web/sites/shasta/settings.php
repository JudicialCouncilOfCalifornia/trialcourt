 ...
 * @endcode
 */
$settings['hash_salt'] = 'W8x1mFfSvnWIiKhYgWN2ZtWM3L6WeYg7fdsnFIHt0tRx5Rd0yxLRnRs0k0gRySu2wkMlFODRpg';
...
$settings['config_sync_directory'] = '../config/config-shasta';
$config['config_split.config_split.local']['folder'] = '../config/config-shasta-local';
$settings['file_public_path']  = 'sites/default/files/shasta/default';
...
if (isset($_ENV['PANTHEON_ENVIRONMENT'])) {
  ...
  if (in_array($_ENV['PANTHEON_ENVIRONMENT'], array('live', 'dev'))) {
    $config['search_api.server.solr']['backend_config']['connector_config']['core'] = 'jcc-shasta-live';
  }
  else if ($_ENV['PANTHEON_ENVIRONMENT'] == 'stage') {
    $config['search_api.server.solr']['backend_config']['connector_config']['core'] = 'jcc-shasta-stage';
  }
  else {
    $config['search_api.server.solr']['backend_config']['connector_config']['core'] = 'jcc-shasta-develop';
  }
}
...
// Assumes local.
  ...
  $config['config_split.config_split.stage']['status'] = TRUE;
  $config['search_api.server.solr']['backend_config']['connector_config']['core'] = 'jcc-shasta-sandbox-1';
}
