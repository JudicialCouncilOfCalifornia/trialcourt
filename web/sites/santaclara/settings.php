 ...
 * @endcode
 */
$settings['hash_salt'] = 'g5gFeySJy6aOJMMV6CQZ3dPjNYo35F_0e9EMOuMo3-VZVf58RUEDog5qKV1wFVRpn0EF2d11jA';
...
$settings['config_sync_directory'] = '../config/config-santaclara';
$config['config_split.config_split.local']['folder'] = '../config/config-santaclara-local';
$settings['file_public_path']  = 'sites/default/files/santaclara/default';
...
if (isset($_ENV['PANTHEON_ENVIRONMENT'])) {
  ...
  if (in_array($_ENV['PANTHEON_ENVIRONMENT'], array('live', 'dev'))) {
    $config['search_api.server.solr']['backend_config']['connector_config']['core'] = 'jcc-santaclara-live';
  }
  else if ($_ENV['PANTHEON_ENVIRONMENT'] == 'stage') {
    $config['search_api.server.solr']['backend_config']['connector_config']['core'] = 'jcc-santaclara-stage';
  }
  else {
    $config['search_api.server.solr']['backend_config']['connector_config']['core'] = 'jcc-santaclara-develop';
  }
}
...
// Assumes local.
  ...
  $config['config_split.config_split.stage']['status'] = TRUE;
  $config['search_api.server.solr']['backend_config']['connector_config']['core'] = 'jcc-santaclara-sandbox-1';
}
