 ...
 * another environment.
 */
$settings['file_private_path'] = 'sites/default/files/idm/default/private';
...
if ($is_installer_url) {
  $config_directories = array(
    CONFIG_SYNC_DIRECTORY => 'sites/default/files/idm',
  );
}
else {
  $config_directories = array(
    CONFIG_SYNC_DIRECTORY => '../config/config-idm',
  );
}
