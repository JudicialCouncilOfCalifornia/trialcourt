 ...
 * @endcode
 */
$settings['hash_salt'] = '7gl22mo94td-Ou6K94l27jLcGKTleoddI7DexJGwj7HlEBfDdXLly8KDV8ZPEpx1wpHCkjkabg';
...
$settings['config_sync_directory'] = '../config/config-phptest';
$config['config_split.config_split.local']['folder'] = '../config/config-phptest-local';
$settings['file_public_path']  = 'sites/default/files/phptest/default';
...
if (isset($_ENV['PANTHEON_ENVIRONMENT'])) {
  ...
  if (in_array($_ENV['PANTHEON_ENVIRONMENT'], array('live', 'dev'))) {
    $config['search_api.server.solr']['backend_config']['connector_config']['core'] = 'jcc-phptest-live';
  }
  else if ($_ENV['PANTHEON_ENVIRONMENT'] == 'stage') {
    $config['search_api.server.solr']['backend_config']['connector_config']['core'] = 'jcc-phptest-stage';
  }
  else {
    $config['search_api.server.solr']['backend_config']['connector_config']['core'] = 'jcc-phptest-develop';
  }
}
...
// Assumes local.
  ...
  $config['config_split.config_split.stage']['status'] = TRUE;
  $config['search_api.server.solr']['backend_config']['connector_config']['core'] = 'jcc-phptest-sandbox-1';
}
