 ...
 * another environment.
 */
$settings['file_private_path'] = 'sites/default/files/alameda/default/private';
...
if ($is_installer_url) {
  $config_directories = array(
    CONFIG_SYNC_DIRECTORY => 'sites/default/files/alameda',
  );
}
else {
  $config_directories = array(
    CONFIG_SYNC_DIRECTORY => '../config/config-alameda',
  );
}
