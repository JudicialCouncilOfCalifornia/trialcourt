 ...
 * another environment.
 */
$settings['file_private_path'] = 'sites/default/files/private/orange';
...
if ($is_installer_url) {
  $config_directories = [
    CONFIG_SYNC_DIRECTORY => 'sites/default/files/orange',
  ];
}
else {
  $config_directories = [
    CONFIG_SYNC_DIRECTORY => '../config/config-orange',
  ];
}
