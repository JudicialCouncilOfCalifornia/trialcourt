 ...
 * @endcode
 */
$settings['hash_salt'] = 'oDBgtNXdrySu3YOcb4bo4ALfaHWKkO4Ge2fG7-m-GQCm9XNxWdbtfeTZQbhkAjgvyPUjJNqJ0w';
...
$settings['config_sync_directory'] = '../config/config-newsitesolr';
$config['config_split.config_split.local']['folder'] = '../config/config-newsitesolr-local';
$settings['file_public_path']  = 'sites/default/files/newsitesolr/default';
...
if (isset($_ENV['PANTHEON_ENVIRONMENT'])) {
  ...
  if (in_array($_ENV['PANTHEON_ENVIRONMENT'], array('live', 'dev'))) {
    $config['search_api.server.solr']['backend_config']['connector_config']['core'] = 'jcc-newsitesolr-live';
  }
  else if ($_ENV['PANTHEON_ENVIRONMENT'] == 'stage') {
    $config['search_api.server.solr']['backend_config']['connector_config']['core'] = 'jcc-newsitesolr-stage';
  }
  else {
    $config['search_api.server.solr']['backend_config']['connector_config']['core'] = 'jcc-newsitesolr-develop';
  }
}
...
// Assumes local.
  ...
  $config['config_split.config_split.stage']['status'] = TRUE;
  $config['search_api.server.solr']['backend_config']['connector_config']['core'] = 'jcc-newsitesolr-sandbox-1';
}
