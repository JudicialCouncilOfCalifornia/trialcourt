 ...
 * another environment.
 */
$settings['file_private_path'] = 'sites/default/files/private/yuba';
...
if ($is_installer_url) {
  $config_directories = [
    CONFIG_SYNC_DIRECTORY => 'sites/default/files/yuba',
  ];
}
else {
  $config_directories = [
    CONFIG_SYNC_DIRECTORY => '../config/config-yuba',
  ];
}
...
/**
 * Override the $databases variable.
 *
 * To pass the correct Database credentials
