 ...
 * another environment.
 */
$settings['file_private_path'] = 'sites/default/files/private/amador';
...
if ($is_installer_url) {
  $config_directories = [
    CONFIG_SYNC_DIRECTORY => 'sites/default/files/amador',
  ];
}
else {
  $config_directories = [
    CONFIG_SYNC_DIRECTORY => '../config/config-amador',
  ];
}
 ...
 * Configure redis.
 */
if (defined('PANTHEON_ENVIRONMENT') && $_ENV['PANTHEON_ENVIRONMENT'] == 'none') {
