 ...
 * another environment.
 */
$settings['file_private_path'] = 'sites/default/files/sanbenito/default/private';
...
if ($is_installer_url) {
  $config_directories = array(
    CONFIG_SYNC_DIRECTORY => 'sites/default/files/sanbenito',
  );
}
else {
  $config_directories = array(
    CONFIG_SYNC_DIRECTORY => '../config/config-sanbenito',
  );
}
