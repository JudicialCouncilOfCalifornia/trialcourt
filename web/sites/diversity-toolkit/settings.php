 ...
 * @endcode
 */
$settings['hash_salt'] = 'GEJWHKXTLS2Y5AlAwNnQMvUQH5ewOurrrGvXWwcnQBm5E59DWXUFoxbHEBvpjBrDtM3zFvn5rg';
...
$settings['config_sync_directory'] = '../config/config-diversity-toolkit';
$config['config_split.config_split.local']['folder'] = '../config/config-diversity-toolkit-local';
$settings['file_public_path']  = 'sites/default/files/diversity-toolkit/default';
...
if (isset($_ENV['PANTHEON_ENVIRONMENT'])) {
  ...
  if (in_array($_ENV['PANTHEON_ENVIRONMENT'], array('live', 'dev'))) {
    $config['search_api.server.solr']['backend_config']['connector_config']['core'] = 'jcc-diversity-toolkit-live';
  }
  else if ($_ENV['PANTHEON_ENVIRONMENT'] == 'stage') {
    $config['search_api.server.solr']['backend_config']['connector_config']['core'] = 'jcc-diversity-toolkit-stage';
  }
  else {
    $config['search_api.server.solr']['backend_config']['connector_config']['core'] = 'jcc-diversity-toolkit-develop';
  }
}
...
// Assumes local.
  ...
  $config['config_split.config_split.stage']['status'] = TRUE;
  $config['search_api.server.solr']['backend_config']['connector_config']['core'] = 'jcc-diversity-toolkit-sandbox-1';
}
