 ...
 * another environment.
 */
$settings['file_private_path'] = 'sites/default/files/mendocino/default/private';
...
if ($is_installer_url) {
  $config_directories = array(
    CONFIG_SYNC_DIRECTORY => 'sites/default/files/mendocino',
  );
}
else {
  $config_directories = array(
    CONFIG_SYNC_DIRECTORY => '../config/config-mendocino',
  );
}
