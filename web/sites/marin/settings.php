 ...
 * @endcode
 */
$settings['hash_salt'] = '4j1VEOHwHc52gcnUaY4zudyzZ1PmQOBap79L0TTi-91B_OPjZ-G_xEnCGAKLdxWUZDYEGvBdpg';
...
$settings['config_sync_directory'] = '../config/config-marin';
$config['config_split.config_split.local']['folder'] = '../config/config-marin-local';
$settings['file_public_path']  = 'sites/default/files/marin/default';
...
if (isset($_ENV['PANTHEON_ENVIRONMENT'])) {
  ...
  if (in_array($_ENV['PANTHEON_ENVIRONMENT'], array('live', 'dev'))) {
    $config['search_api.server.solr']['backend_config']['connector_config']['core'] = 'jcc-marin-live';
  }
  else if ($_ENV['PANTHEON_ENVIRONMENT'] == 'stage') {
    $config['search_api.server.solr']['backend_config']['connector_config']['core'] = 'jcc-marin-stage';
  }
  else {
    $config['search_api.server.solr']['backend_config']['connector_config']['core'] = 'jcc-marin-develop';
  }
}
...
// Assumes local.
  ...
  $config['config_split.config_split.stage']['status'] = TRUE;
  $config['search_api.server.solr']['backend_config']['connector_config']['core'] = 'jcc-marin-sandbox-1';
}
