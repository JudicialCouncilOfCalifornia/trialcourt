 ...
 * @endcode
 */
$settings['hash_salt'] = 'tA7Jk-bkhxK925TxvTgWBikw6D0cHnm9n1Cj1ighCO1Pl_tUlEdj1I1YKJZf0MlD_BKUl5AcMw';
...
$settings['config_sync_directory'] = '../config/config-calaveras';
$config['config_split.config_split.local']['folder'] = '../config/config-calaveras-local';
$settings['file_public_path']  = 'sites/default/files/calaveras/default';
...
if (isset($_ENV['PANTHEON_ENVIRONMENT'])) {
  ...
  if (in_array($_ENV['PANTHEON_ENVIRONMENT'], array('live', 'dev'))) {
    $config['search_api.server.solr']['backend_config']['connector_config']['core'] = 'jcc-calaveras-live';
  }
  else if ($_ENV['PANTHEON_ENVIRONMENT'] == 'stage') {
    $config['search_api.server.solr']['backend_config']['connector_config']['core'] = 'jcc-calaveras-stage';
  }
  else {
    $config['search_api.server.solr']['backend_config']['connector_config']['core'] = 'jcc-calaveras-develop';
  }
}
...
// Assumes local.
  ...
  $config['config_split.config_split.stage']['status'] = TRUE;
  $config['search_api.server.solr']['backend_config']['connector_config']['core'] = 'jcc-calaveras-sandbox-1';
}
