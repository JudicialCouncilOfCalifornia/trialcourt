 ...
 * another environment.
 */
$settings['file_private_path'] = 'sites/default/files/colusa/default/private';
...
if ($is_installer_url) {
  $config_directories = array(
    CONFIG_SYNC_DIRECTORY => 'sites/default/files/colusa',
  );
}
else {
  $config_directories = array(
    CONFIG_SYNC_DIRECTORY => '../config/config-colusa',
  );
}
