 ...
 * another environment.
 */
$settings['file_private_path'] = 'sites/default/files/imperial/default/private';
...
if ($is_installer_url) {
  $config_directories = array(
    CONFIG_SYNC_DIRECTORY => 'sites/default/files/imperial',
  );
}
else {
  $config_directories = array(
    CONFIG_SYNC_DIRECTORY => '../config/config-imperial',
  );
}
