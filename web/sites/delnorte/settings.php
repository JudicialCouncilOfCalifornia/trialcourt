 ...
 * @endcode
 */
$settings['hash_salt'] = 'uK3hlwMMwkW6vUfUP4MAaDaD-e_nShHmG_8DAOuy_F2DuKOcnSLtHnfbOj5sabOSwpGl3-eNUg';
...
$settings['config_sync_directory'] = '../config/config-delnorte';
$config['config_split.config_split.local']['folder'] = '../config/config-delnorte-local';
$settings['file_public_path']  = 'sites/default/files/delnorte/default';
...
if (isset($_ENV['PANTHEON_ENVIRONMENT'])) {
  ...
  if (in_array($_ENV['PANTHEON_ENVIRONMENT'], array('live', 'dev'))) {
    $config['search_api.server.solr']['backend_config']['connector_config']['core'] = 'jcc-delnorte-live';
  }
  else if ($_ENV['PANTHEON_ENVIRONMENT'] == 'stage') {
    $config['search_api.server.solr']['backend_config']['connector_config']['core'] = 'jcc-delnorte-stage';
  }
  else {
    $config['search_api.server.solr']['backend_config']['connector_config']['core'] = 'jcc-delnorte-develop';
  }
}
...
// Assumes local.
  ...
  $config['config_split.config_split.stage']['status'] = TRUE;
  $config['search_api.server.solr']['backend_config']['connector_config']['core'] = 'jcc-delnorte-sandbox-1';
}
