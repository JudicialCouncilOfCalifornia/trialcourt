 ...
 * @endcode
 */
$settings['hash_salt'] = 'fp44d3O5tec1MvE8VLzSc2P0r8jP37qDyS9FdGCnY9pWnCPrvshPO93bOySq9Uz8QCer-UXfIg';
...
$settings['config_sync_directory'] = '../config/config-solano';
$config['config_split.config_split.local']['folder'] = '../config/config-solano-local';
$settings['file_public_path']  = 'sites/default/files/solano/default';
...
if (isset($_ENV['PANTHEON_ENVIRONMENT'])) {
  ...
  if (in_array($_ENV['PANTHEON_ENVIRONMENT'], array('live', 'dev'))) {
    $config['search_api.server.solr']['backend_config']['connector_config']['core'] = 'jcc-solano-live';
  }
  else if ($_ENV['PANTHEON_ENVIRONMENT'] == 'stage') {
    $config['search_api.server.solr']['backend_config']['connector_config']['core'] = 'jcc-solano-stage';
  }
  else {
    $config['search_api.server.solr']['backend_config']['connector_config']['core'] = 'jcc-solano-develop';
  }
}
...
// Assumes local.
  ...
  $config['config_split.config_split.stage']['status'] = TRUE;
  $config['search_api.server.solr']['backend_config']['connector_config']['core'] = 'jcc-solano-sandbox-1';
}
