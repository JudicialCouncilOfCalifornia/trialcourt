 ...
 * another environment.
 */
$settings['file_private_path'] = 'sites/default/files/sanfrancisco/default/private';
...
if ($is_installer_url) {
  $config_directories = array(
    CONFIG_SYNC_DIRECTORY => 'sites/default/files/sanfrancisco',
  );
}
else {
  $config_directories = array(
    CONFIG_SYNC_DIRECTORY => '../config/config-sanfrancisco',
  );
}
