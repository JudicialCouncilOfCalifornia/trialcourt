 ...
 * another environment.
 */
$settings['file_private_path'] = 'sites/default/files/inyo/default/private';
...
if ($is_installer_url) {
  $config_directories = array(
    CONFIG_SYNC_DIRECTORY => 'sites/default/files/inyo',
  );
}
else {
  $config_directories = array(
    CONFIG_SYNC_DIRECTORY => '../config/config-inyo',
  );
}
