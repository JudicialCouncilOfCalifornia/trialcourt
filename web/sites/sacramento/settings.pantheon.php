 ...
 * another environment.
 */
$settings['file_private_path'] = 'sites/default/files/sacramento/default/private';
...
if ($is_installer_url) {
  $config_directories = array(
    CONFIG_SYNC_DIRECTORY => 'sites/default/files/sacramento',
  );
}
else {
  $config_directories = array(
    CONFIG_SYNC_DIRECTORY => '../config/config-sacramento',
  );
}
