 ...
 * another environment.
 */
$settings['file_private_path'] = 'sites/default/files/sandiego/default/private';
...
if ($is_installer_url) {
  $config_directories = array(
    CONFIG_SYNC_DIRECTORY => 'sites/default/files/sandiego',
  );
}
else {
  $config_directories = array(
    CONFIG_SYNC_DIRECTORY => '../config/config-sandiego',
  );
}
