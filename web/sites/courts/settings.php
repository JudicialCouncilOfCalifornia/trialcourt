 ...
 * @endcode
 */
$settings['hash_salt'] = 'whDx0k95rBvIzN2EZB8aaDwaUfDNNpI-hrPn5thpFxGIGtOg1LqkxRk0VhzIVElEIDkVZ9n_Hw';
...
$settings['config_sync_directory'] = '../config/config-courts';
$config['config_split.config_split.local']['folder'] = '../config/config-courts-local';
$settings['file_public_path']  = 'sites/default/files/courts/default';
...
if (isset($_ENV['PANTHEON_ENVIRONMENT'])) {
  ...
  if (in_array($_ENV['PANTHEON_ENVIRONMENT'], array('live', 'dev'))) {
    $config['search_api.server.solr']['backend_config']['connector_config']['core'] = 'jcc-courts-live';
  }
  else if ($_ENV['PANTHEON_ENVIRONMENT'] == 'stage') {
    $config['search_api.server.solr']['backend_config']['connector_config']['core'] = 'jcc-courts-stage';
  }
  else {
    $config['search_api.server.solr']['backend_config']['connector_config']['core'] = 'jcc-courts-develop';
  }
}
