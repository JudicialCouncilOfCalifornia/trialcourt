      ...
      $(".jcc-fieldset-search input").on("keyup", function (e) {
        ...
        if (keyword) {
          $(".jcc-fieldset-search").append(function () {
              return `
              <span class="usa-hint position-absolute">
                <div class="usa-alert usa-alert--warning usa-alert--no-icon usa-alert--slim margin-top-1">
                  <div class="usa-alert__body">
                    <p class="usa-alert__text">
                      ...
                      <a href="/search?keywords=${keyword}&f[0]=document_type%3A28" class="text-no-underline"><span class="usa-tag bg-accent-warm-darker padding-y-05 hover:bg-accent-cool-dark">Case Summaries</span></a>
                      <a href="/search?keywords=${keyword}&f[0]=document_type%3A1457" class="text-no-underline"><span class="usa-tag bg-accent-warm-darker padding-y-05 hover:bg-accent-cool-dark">Research Reports</span></a>
                      <a href="/search?keywords=${keyword}&f[0]=document_type%3A1444" class="text-no-underline"><span class="usa-tag bg-accent-warm-darker padding-y-05 hover:bg-accent-cool-dark">Articles</span></a>
                    </p>
                  </div>
                </div>
              </span>`;
