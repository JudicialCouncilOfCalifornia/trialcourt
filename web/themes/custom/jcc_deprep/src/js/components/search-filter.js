                ...
                <div class="usa-alert usa-alert--warning usa-alert--no-icon usa-alert--slim margin-top-1">
                  <div class="usa-alert__body">
                    <p class="usa-alert__text">
                      ...
                      <a href="/search?keywords=${keyword}&f[0]=document_type%3A26" class="text-no-underline"><span class="usa-tag bg-accent-warm-darker padding-y-05 hover:bg-accent-cool-dark">Publications</span></a>
                      <a href="/search?keywords=${keyword}&f[0]=document_type%3A23" class="text-no-underline"><span class="usa-tag bg-accent-warm-darker padding-y-05 hover:bg-accent-cool-dark">Training</span></a>
