...
class SubThemeGenerator {
  ...
  protected function getFileContentReplacementPairs(): array {
    return [
      'JCC_BASE_SUBTHEME_NAME' => $this->getName(),
      'JCC_BASE_SUBTHEME_DESCRIPTION' => $this->getDescription(),
      'JCC_BASE_SUBTHEME_MACHINE_NAME' => $this->getMachineName(),
      "\nhidden: true\n" => "\n",
    ];
  }
